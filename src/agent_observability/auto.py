...
from agent_observability.otel_setup import ExporterType
...
#   patch_module : dotted path under agent_observability._patch

_REGISTRY: dict[str, tuple[str, str]] = {
    "langchain": ("langchain_core", "agent_observability._patch.langchain"),
    "langgraph": ("langgraph", "agent_observability._patch.langgraph"),
    "openai_agents": ("agents", "agent_observability._patch.openai_agents"),
    "anthropic": ("anthropic", "agent_observability._patch.anthropic"),
    "crewai": ("crewai", "agent_observability._patch.crewai"),
    "autogen": ("autogen", "agent_observability._patch.autogen"),
    "llamaindex": ("llama_index.core", "agent_observability._patch.llamaindex"),
    "semantic_kernel": ("semantic_kernel", "agent_observability._patch.semantic_kernel"),
    "google_adk": ("google.adk", "agent_observability._patch.google_adk"),
    "bedrock": ("botocore", "agent_observability._patch.bedrock"),
    "haystack": ("haystack", "agent_observability._patch.haystack"),
    "smolagents": ("smolagents", "agent_observability._patch.smolagents"),
    "pydantic_ai": ("pydantic_ai", "agent_observability._patch.pydantic_ai"),
    "phidata": ("phi", "agent_observability._patch.phidata"),
}
...
def auto_instrument(
    *,
    ...
    ----------
    service_name : str
        OpenTelemetry service name (default ``"agent-observability"``).
...
def _make_single_instrument(name: str) -> Callable[..., bool]:
    ...
    _instrument.__doc__ = f"""Instrument {name} with agent-observability.
